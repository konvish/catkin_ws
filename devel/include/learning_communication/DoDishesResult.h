...
struct DoDishesResult_
{
  ...
  (void)_alloc;
   ...
   typedef uint32_t _total_disher_cleaned_type;
  _total_disher_cleaned_type total_disher_cleaned;
...
{
  return lhs.total_disher_cleaned == rhs.total_disher_cleaned;
}
...
struct MD5Sum< ::learning_communication::DoDishesResult_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xba8df941a54eb146ULL;
  static const uint64_t static_value2 = 0xaac99482e945ac26ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::learning_communication::DoDishesResult_<ContainerAllocator> >
  {
    ...
    {
      stream.next(m.total_disher_cleaned);
    }
...
struct Printer< ::learning_communication::DoDishesResult_<ContainerAllocator> >
{
  ...
  {
    s << indent << "total_disher_cleaned: ";
    Printer<uint32_t>::stream(s, indent + "  ", v.total_disher_cleaned);
  }
};
