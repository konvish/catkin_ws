...
if("TRUE" STREQUAL "TRUE")
  set(marm_planning_SOURCE_PREFIX /home/kong/carkin_ws/src/marm_planning)
  set(marm_planning_DEVEL_PREFIX /home/kong/carkin_ws/devel)
  ...
  set(marm_planning_INSTALL_PREFIX /home/kong/carkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'marm_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kong/carkin_ws/src/marm_planning/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(marm_planning_EXPORTED_TARGETS ${${marm_planning_dep}_EXPORTED_TARGETS})
endforeach()
