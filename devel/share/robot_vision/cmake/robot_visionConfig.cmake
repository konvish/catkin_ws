...
if("TRUE" STREQUAL "TRUE")
  set(robot_vision_SOURCE_PREFIX /home/kong/carkin_ws/src/robot_vision)
  set(robot_vision_DEVEL_PREFIX /home/kong/carkin_ws/devel)
  ...
  set(robot_vision_INSTALL_PREFIX /home/kong/carkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_vision' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kong/carkin_ws/src/robot_vision/${idir}'.  ${_report}")
    endif()
